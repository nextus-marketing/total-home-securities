...
<head>
        ...
        <meta name="description" content="Protect your home with our professional security system installations. We offer motion detectors, alarms, cameras, high security locks, and smart lighting.">
...
<header class="header-area header-three">  
    ...
    <div id="header-sticky" class="menu-area">
        ...
        @yield('content')
        <footer class="footer-bg footer-p" style="background:#f5edf9;">
                ...
                <div class="col-xl-5 col-lg-3 col-sm-6">
                    <div class="footer-widget mb-15">
                        <div class="f-widget-title mb-30">
                            <a href="/">
                            <img src="/frontend/my-img/new-logo.png" alt="img" style="max-width:220px;">      
                            </a>                             
                        </div>
                      <p style="color:#444;">
                       <b>Total Home Securities</b>  provides trusted home protection solutions with reliable service and expert support for your family’s safety.
                        We’re committed to keeping every home safe, secure, and worry-free.
                        Our team focuses on delivering smart security options that fit your home and lifestyle.
                        With dependable support and modern technology, we make home protection simple and stress-free.
                    </p>
                ...
                <div class="col-xl-2 col-lg-2 col-sm-6">
                    <div class="footer-widget mb-30">
                        <div class="f-widget-title">
                            <h2 style="color:#000;">Our Links</h2>
                        </div>
                    ...
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-link">
                            <ul>
                                ...
                                <li><a href="tel:+18437994445">+1 (843) 799-4445</a></li>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <!-- RIGHT SIDE FIRST -->
            <div class="col-lg-5">                         
                <div class="text">Copyright © 2025 Total Home Securities. All rights reserved.</div>      
            </div>
                ...
                <ul>
                    ...
                    <li>
                        <a href="/return-and-refund-policy">
                            <div class="text2">Returns & Refunds Policy</div>
                        </a>
                    </li>
                </ul>
            </div>
...
<style>
   ...
   width: 50px;
    ...
    box-shadow: 0 6px 20px rgba(202, 96, 232, 0.45);
}
...
@keyframes pulseCall {
    0% {
        transform: scale(1);
        box-shadow: 0 0 0 0 rgba(202, 96, 232, 0.7);
    }
    50% {
